class AutoScore {
  ...
  init(difficulty, level, scoremode, circles) {
    ...
    this.basic_max_score_list = {
      oni: [
        1200000, 700000, 750000, 800000, 850000, 900000, 950000, 1000000,
        1050000, 1100000, 1200000,
      ],
      ura: [
        1200000, 700000, 750000, 800000, 850000, 900000, 950000, 1000000,
        1050000, 1100000, 1200000,
      ...
      hard: [
        900000, 550000, 600000, 650000, 700000, 750000, 800000, 850000, 900000,
      ],
      normal: [700000, 400000, 450000, 500000, 550000, 600000, 650000, 700000],
      easy: [380000, 300000, 320000, 340000, 360000, 380000],
    };
  ...
  TryScore(init, diff) {
    ...
    for (var circle of this.circles) {
      ...
      switch (circle.type) {
        ...
        case 'ka': {
          score +=
            Math.floor(((init + diff * diff_mul) * multiplier) / 10) * 10;
          break;
        }
        case 'daiDon':
        case 'daiKa': {
