    ...
    this.addEdits(
      ...
      new EditFunction(Game.prototype, 'playMainMusic').load((str) => {
        ...
        return plugins.insertAfter(
          ...
          `, undefined, this.controller.getPlaybackRate()`
        );
      }),
      ...
      new EditValue(Controller.prototype, 'getPlaybackRate').load(() =>
        this.getPlaybackRate.bind(this)
      ),
      new EditFunction(SongSelect.prototype, 'previewLoaded').load((str) => {
        return plugins.insertAfter(
          str,
          'this.preview.playLoop(delay / 1000, false, prvTime',
          `, undefined, undefined, this.getPlaybackRate()`
        );
      }),
      new EditValue(SongSelect.prototype, 'getPlaybackRate').load(() =>
        this.getPlaybackRate.bind(this)
      )
    );
  }
